...
const GetNotificationEventsUseCase_1 = require("../../../src/core/use_cases/GetNotificationEventsUseCase");
...
describe('GetNotificationEventsUseCase', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new GetNotificationEventsUseCase_1.GetNotificationEventsUseCase(repository);
    });
